...
- (SBIconListView *)_currentIconListView; //iOS 8 - 12
...
- (SBFolderController *)initWithFolder:(SBFolder *)folder orientation:(int)orientation; //iOS 7.0 - 8.1
- (SBFolderController *)initWithFolder:(SBFolder *)folder orientation:(int)orientation viewMap:(SBIconViewMap *)map; //iOS 8.2 - 12
...
- (void)pushExpandedTreeNode:(SBFolderIcon *)folderIcon animated:(BOOL)animated withCompletion:(id)completion;
- (void)popExpandedTreeNodeAnimated:(BOOL)animated withCompletion:(id)completion;
...
- (void)setInnerFolderController:(SBFolderController *)innerFolderController;
- (int)orientation;
- (SBIconViewMap *)viewMap;
